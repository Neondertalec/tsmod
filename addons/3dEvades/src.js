...
globalThis.createArc = function(ctx, x, y, r){
...
addReplaces('this.renderShadowedInvulnerabilityEffect(e,r,a)',
            ...
            'e.closePath(),e.beginPath(),e.arc(r, a, this.radius, 0, 2 * Math.PI, !1), e.fillStyle = globalThis.createArc(e, r, a, this.radius), e.fill()');
